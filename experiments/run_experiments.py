...
def start_experiments(experiments=None):
	...
	for experiment in experiments:
		list_of_experiments.extend(run_experiment(experiment))

	print("STARTED THE PARALLEL JOB")
	Parallel(n_jobs=50)(delayed(run_experiment_now)(exp) for exp in list_of_experiments)
